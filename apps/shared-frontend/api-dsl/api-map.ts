export type APIMap = {
  ...
  components: {
    schemas: {
      ...
      TeacherPreviewResponseDto: { type: 'object', properties: { id: { type: 'integer', format: 'int32' }, name: { type: 'string' } }, additionalProperties: false },
      TeacherResponseDto: {
        type: 'object',
      ...
      UpdateNewsRequestDto: {
        type: 'object',
        properties: { id: { type: 'integer', format: 'int32' }, previewImage: { type: 'string' }, date: { type: 'string', format: 'date' }, images: { type: 'array', items: { '$ref': '#/components/schemas/CreateNewsImageRequestDto' } } },
        additionalProperties: false
      },
